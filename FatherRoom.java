...
public class FatherRoom {
        ...
        AnimationTimer timer=new AnimationTimer() {
            ...
            public void handle(long now) {
                ...
                if(playerX>891&&playerY>701&&removeFatherRoom){
                    ...
                    GameView gameView=new GameView(162,31);
    ...
    private void createGameBackground(){
        Image backgroundImage= new Image("file:/Users/linchengwei/IdeaProjects/SpaceRunner2/src/view/fatherroom.png",1024,800,false,true);
