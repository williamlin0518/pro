...
public class Player extends Pane {
    ...
    public int PLAYER_WIDTH=63;//(int) GameView.playerImage.getWidth()/GameView.columnImage;
    public int PLAYER_HEIGHT=96;//(int) GameView.playerImage.getWidth()/GameView.rowImage;
